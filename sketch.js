...
function preload(){
 ...
 Img = loadAnimation("Walking Frame/walking_1.png", "Walking Frame/walking_2.png",
...
function setup(){
    ...
    umbrellas = new Umbrella(250, 500);
